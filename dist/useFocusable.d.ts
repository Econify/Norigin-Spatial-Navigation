...
export declare type BoundaryHitHandler<P = object> = (boundaryDirection: Direction, props: P) => void;
export declare type ArrowPressHandler<P = object> = (direction: string, props: P, details: KeyPressDetails) => boolean;
export declare type ArrowReleaseHandler<P = object> = (direction: string, props: P) => void;
